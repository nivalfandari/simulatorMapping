...
public:
     ...
     */
    Simulator(std::string ORBSLAMConfigFile, std::string model_path, bool alignModelToTexture, std::string modelTextureNameToAlignTo, bool trackImages = true,
     ...
     * */
    std::thread run(const std::string& modelName, const std::string& displayName);
    /**
    ...
    void simulatorRunThread_orig(const std::string& modelName, const std::string& displayName);
    void simulatorRunThread_orig2();
    void simulatorRunThread_two(const std::string& modelName, const std::string& displayName);
    void simulatorRunThread(const std::string& modelName, const std::string& displayName);
    void simulatorRunThread_multi(const std::string& modelName, const std::string& displayName);
    void simulatorRunThread_nerf(const std::string& modelName, const std::string& displayName);
